...
const main = async () => {
    ...
    const bytecodeSender = fs.readFileSync('./contracts/bin/TokenSender_sol_TokenSender.bin');
    const bytecodeReceiver = fs.readFileSync('./contracts/bin/TokenReceiver_sol_TokenReceiver.bin');
